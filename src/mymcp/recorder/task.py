        ...
        try:
            ...
            while not self._stop.is_set():
                ...
                if self._circuit_open:
                    # Skip merge calls entirely; just idle until shutdown or
                    # the next loop tick. Restart of the process is the only
                    # reset path (intentional — no admin reset endpoint).
